...
function selectAmount($amount=1,$total=10){
	...
	for($i=1;$i<=$total;$i++){
		...
		$output .= "<option ".($i==$amount?"selected":
			"").">$i</option>";
	}
	$output .= "</select>";
	return $output;
	...
	function cartTotals() {
		...
		return <<<HTML
					...
					<div class="card-section">
						<a href="./lib/styleguide/product_checkout.php" class="form-button">Checkout</a>
					</div>
		...
		function reccomendedCategory($cat,$limit=3){
		...
		function reccomendedSimilar($cat,$id=0,$limit=3){
